...
export default function XAgentPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#C9A24D]">Admin</p>
      ...
      <div className="space-y-4 rounded-2xl border border-white/10 bg-[#111620] p-6">
        <div className="flex gap-3">
          <input
            ...
            className="flex-1 rounded-xl border border-white/10 bg-[#0B1120] px-4 py-2.5 text-sm text-white placeholder:text-white/30 outline-none focus:border-[#C9A24D]/40"
          />
          <button
            type="button"
            onClick={handleGenerate}
            disabled={generating || !topic.trim()}
            className="rounded-xl border border-[#C9A24D]/25 bg-[#C9A24D]/10 px-4 py-2.5 text-sm font-medium text-[#E7C980] hover:bg-[#C9A24D]/15 disabled:cursor-not-allowed disabled:opacity-40"
          >
              ...
              {alternatives.map((opt, i) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    <span className="rounded bg-[#C9A24D]/15 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-[#C9A24D]/90">
                      {opt.label}
                    </span>
                  ...
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <button
                      ...
                      className="rounded-lg border border-[#C9A24D]/25 bg-[#C9A24D]/10 px-3 py-1 text-[11px] font-semibold text-[#E7C980] hover:bg-[#C9A24D]/20"
                    >
                      Usar esta
                    </button>
                  </div>
        ...
        <div className="relative">
          <textarea
            ...
            rows={4}
            className="w-full resize-none rounded-xl border border-white/10 bg-[#0B1120] px-4 py-3 text-sm text-white placeholder:text-white/30 outline-none focus:border-[#C9A24D]/40"
          />
            ...
            {VISUAL_TYPES.map((vt) => (
              <button
                ...
                className={`rounded-lg border px-3 py-1 text-[11px] font-semibold uppercase tracking-wide transition ${
                  visualType === vt.value
                    ? "border-[#C9A24D]/35 bg-[#C9A24D]/15 text-[#C9A24D]"
            ...
            <>
              <div className="grid grid-cols-2 gap-3">
                <input
                  ...
                  className="rounded-xl border border-white/10 bg-[#0B1120] px-3 py-2 text-sm text-white placeholder:text-white/25 outline-none focus:border-[#C9A24D]/40"
                />
                <div className="space-y-2">
                  <input
                    type="text"
                    ...
                    className="w-full rounded-xl border border-white/10 bg-[#0B1120] px-3 py-2 text-sm text-white placeholder:text-white/25 outline-none focus:border-[#C9A24D]/40"
                  />
                  <div className="flex flex-wrap gap-1.5">
              ...
              <div className="space-y-2">
                {matches.map((m, i) => (
                  <div key={i} className="grid grid-cols-[1fr_6rem_1fr_auto] items-center gap-2">
                    <input
                      type="text"
                      placeholder="Local"
                      value={m.home}
                    ...
                    <input
                      ...
                      className="rounded-xl border border-white/10 bg-[#0B1120] px-3 py-2 text-center text-sm font-bold tabular-nums text-white placeholder:text-white/25 outline-none focus:border-[#C9A24D]/40"
                    />
                    <input
                      type="text"
          ...
          {visualType === "quote_card" && (
            <div className="space-y-2">
              <textarea
                ...
                rows={3}
                className="w-full resize-none rounded-xl border border-white/10 bg-[#0B1120] px-3 py-2 text-sm text-white placeholder:text-white/25 outline-none focus:border-[#C9A24D]/40"
              />
              <div className="grid grid-cols-2 gap-3">
                <input
                  type="text"
            ...
            {imageUrl && (
              <>
                <button
                  ...
                  className="rounded-xl border border-[#C9A24D]/25 bg-[#C9A24D]/10 px-4 py-2 text-sm font-medium text-[#E7C980] hover:bg-[#C9A24D]/15 disabled:cursor-not-allowed disabled:opacity-40"
                >
        ...
        <div className="flex justify-end">
          <button
            ...
            className="rounded-xl bg-[#C9A24D] px-5 py-2.5 text-sm font-semibold text-[#0B0D12] hover:bg-[#D8B45F] disabled:cursor-not-allowed disabled:opacity-40"
          >
        ...
        {imagePromptOpen && (
          <div className="space-y-3 border-t border-white/10 px-6 pb-6 pt-4">
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-white/10 bg-[#0B1120] px-4 py-3 text-sm text-white placeholder:text-white/25 outline-none focus:border-[#C9A24D]/40"
            />
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex justify-end gap-2">
                            ...
                            <button
                              ...
                              className="rounded-lg bg-[#C9A24D] px-3 py-1.5 text-xs font-semibold text-[#0B0D12] hover:bg-[#D8B45F] disabled:opacity-40"
                            >
                          ...
                          <div className="mt-3 flex flex-wrap items-center justify-end gap-2">
                            ...
                            {(post.status === "pending_approval" || post.status === "draft" || post.status === "scheduled") && (
                              <button
                                ...
                                disabled={actioning === post.id}
                                className="rounded-lg bg-[#C9A24D] px-3 py-1.5 text-xs font-semibold text-[#0B0D12] hover:bg-[#D8B45F] disabled:opacity-50"
                              >
